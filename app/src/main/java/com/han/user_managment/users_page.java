...
public class users_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_usage);
        ...
        viewuser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),user_recyclerView.class));
            }
        });
    }

    private void logout() {
        userSharedPreference.setUserLoggedIn(false);
        finish();
