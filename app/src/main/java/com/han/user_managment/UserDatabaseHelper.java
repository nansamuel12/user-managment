...
public class UserDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addUser(String fulname,String username,String email,String password,String phone,String gender){
        ...
        long flag=userdb.insert(TABLE_NAME, null, values);
        userdb.close();
    ...
    public void deleteUser(String password){
        ...
        db.execSQL("DELETE FROM "+"users"+" WHERE "+COLUMN_USERPASSORD+"=\""+password+"\";");
    }
    public boolean checkUserLogin(String username,String password){
        ...
        Cursor cursor=userdb.query(TABLE_NAME, columns, selectUandP,
